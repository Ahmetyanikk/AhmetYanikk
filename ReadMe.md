...
Python and AI engineer in Istanbul. I build production LLM pipelines and document extraction systems.
...
- 🏗️ Comfortable owning the whole thing: Django/FastAPI backends, multi-tenant data isolation, AWS deployment, and the frontend when it needs one
- 🔭 Currently freelancing on AI backend work and open to remote roles
- 👯 Happy to collaborate on open source Python and LLM tooling
- 📫 ahmetyaniklar@gmail.com
...
![Promptfoo](https://img.shields.io/badge/Promptfoo-2C3E50?style=flat-square)
![Tesseract OCR](https://img.shields.io/badge/Tesseract%20OCR-4A4A4A?style=flat-square)
